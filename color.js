...
{
    userInput[id] = document.getElementById(`userInput${id+1}`).value;
}

function getString(string1, string2, colorHex)
{
    ...
    let currentColorHex = '';
    let spacesString = '';
    let str = string1 + spacesString + '\n' + string2;
    currentColorHex = colorHash.hex(str);
    if(currentColorHex === colorHex)
    {
        return str;
    }

    while(currentColorHex !== colorHex)
    {
        spacesString += ' ';
        str = string1 + spacesString + '\n' + string2;
        currentColorHex = colorHash.hex(str);
    }
    return str;
}
...
function findString()
{
    const str = getString(userInput[0], userInput[1], userInput[2]);
